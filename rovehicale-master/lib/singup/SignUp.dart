...
//--------------------------------
  ...
  loaddata() async
  {
    ...
    if(response.statusCode==200)
    {
      ...
      if(data1[0]['result']=="true")
      {
        Navigator.of(context).pop();
        SnackBar snackBar=new SnackBar(content: new Text("This User Already Exists"),);
      ...
      else
      {
        ...
        if(response1.statusCode==200)
        {
         ...
         // Navigator.push(context, new MaterialPageRoute(builder: (contex)=> new verify(code:code1,phoneno:phoneno)));
...
//      });
  ...
  void _handleSubmitted1() {
    ...
    if (!form.validate()) {
      ...
      debugPrint(code1);
      if(code1 == code){
        Navigator.push(context, new MaterialPageRoute(builder: (context)=>new SignUp2(phoneno: phoneno)));
      }
      else
        {
